...
**업데이트 확인**으로 앱과 지침의 최신 승인 버전을 함께 확인합니다. 기존 앱에서 1.2.2로 업데이트할 때는 **앱 설치 및 재시작…**을 먼저 완료한 뒤, 다시 열린 앱에서 **설치 미리보기 → 적용… → 확인**으로 새 지침을 적용합니다. 앱 업데이트와 지침 적용은 별도 단계입니다. 서명과 파일 해시를 검증한 뒤 설치하며 이전 앱과 설정은 백업합니다.
